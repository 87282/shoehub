...
import { menuItems, menuItemsMobile } from "../components/Profile/ProfileContent";
...
export default function Orders ({ session }: any) {
  ...
  return (
    <div>
      <Header />
      <Sidebar />
      <motion.main className="px-4 max-w-[1120px] mx-auto mt-[8rem] lg:mt-[4rem] min-h-[95vh] lg:grid lg:grid-cols-profile">
        <motion.div
          variants={container}
          initial="hidden"
          animate="visible"
        ...
        >
          ...
          <div>
            <strong className="text-lg">Betalingen</strong>
                ...
                data?.orders && (
                  <div className="flex w-full flex-col align-center justify-center gap-4">
                    {data!.orders.length > 0 ? (
                      ...
                      <span className="text-center">Nog geen Betalingen</span>
                    )}
                  </div>
                )
              }
